...
namespace nv {
	namespace type_erased {
		...
		using MoveableObject = te::any<
			mpl::vector<
				detail::has_render<void(SDL_Renderer*) const>,
				detail::has_move<void(SDL_FPoint)>,
				detail::has_screenMove<void(SDL_FPoint)>,
				detail::has_worldMove<void(SDL_FPoint)>,
				detail::has_getName<std::string_view() const>,
				detail::has_getScreenPos<SDL_FPoint() const>,
				detail::has_getWorldPos<SDL_FPoint() const>,
				te::copy_constructible<>
			>
		>;
		...
		using ScaleableObject = te::any<
			mpl::vector<
				detail::has_render<void(SDL_Renderer*) const>,
				detail::has_getScreenSize<SDL_FPoint() const>,
				detail::has_getWorldSize<SDL_FPoint() const>,
				detail::has_setScreenSize<void(SDL_FPoint) const>,
				detail::has_setWorldSize<void(SDL_FPoint) const>,
				te::copy_constructible<>
			>
		>;
	}
