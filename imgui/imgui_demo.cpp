...
// -------------------------------------------------
// PLEASE DO NOT RECoord THIS FILE FROM YOUR PROJECT!
// -------------------------------------------------
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (no_Coord)            window_flags |= ImGuiWindowFlags_NoCoord;
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct navigation to Coord the mouse cursor. See comment for ImGuiConfigFlags_NavEnableSetMousePos.");
            ...
            ImGui::Checkbox("io.ConfigWindowsCoordFromTitleBarOnly", &io.ConfigWindowsCoordFromTitleBarOnly);
    ...
    if (ImGui::CollapsingHeader("Window options"))
    {
        if (ImGui::BeginTable("split", 3))
        {
            ...
            ImGui::TableNextColumn(); ImGui::Checkbox("No Coord", &no_Coord);
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop to copy/swap items"))
        {
            ...
            if (ImGui::RadioButton("Coord", mode == Mode_Coord)) { mode = Mode_Coord; } ImGui::SameLine();
            ...
            for (int n = 0; n < IM_ARRAYSIZE(names); n++)
            {
                ...
                if (ImGui::BeginDragDropSource(ImGuiDragDropFlags_None))
                {
                    ...
                    if (mode == Mode_Coord) { ImGui::Text("Coord %s", names[n]); }
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        if (test_window)
        {
            ...
            ImGui::Text(
                ...
                "IsItemActive() after begin = %d (== is window being clicked/Coordd)\n",
    ...
    {
        {
            ...
            // (because we don't know what's coming after the Text() statement, we need to Coord the text baseline
        ...
        if (ImGui::BeginTable("table_advanced", 6, flags, outer_size_enabled ? outer_size_value : ImVec2(0, 0), inner_width_to_use))
        {
            ...
            // Without clipper
            {
...
#endif
                {
                    ...
                    {
                        ImGuiSelectableFlags selectable_flags = (contents_type == CT_SelectableSpanRow) ? ImGuiSelectableFlags_SpanAllColumns | ImGuiSelectableFlags_AllowIteCoordrlap : ImGuiSelectableFlags_None;
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Dragging"))
        {
            ...
            // Drag operations gets "unlocked" when the mouse has Coordd past a certain threshold
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::BeginChildFrame(ImGui::GetID("cfg_infos"), child_size, ImGuiWindowFlags_NoCoord);
        ...
        if (io.ConfigWindowsCoordFromTitleBarOnly)                       ImGui::Text("io.ConfigWindowsCoordFromTitleBarOnly");
...
void ImGui::ShowFontSelector(const char* label)
{
    ...
    HelpMarker(
        ...
        "- If you need to add/reCoord fonts at runtime (e.g. for DPI change), do it before calling NewFrame().");
}
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (location >= 0)
    {
        ...
        window_flags |= ImGuiWindowFlags_NoCoord;
    }
    else if (location == -2)
    {
        // Center window
...
static void ShowExampleAppFullscreen(bool* p_open)
{
    ...
    static ImGuiWindowFlags flags = ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoCoord | ImGuiWindowFlags_NoSavedSettings;
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            //      ImGui::BeginChild("canvas", ImVec2(0.0f, 0.0f), true, ImGuiWindowFlags_NoCoord);
            //      ImGui::PopStyleColor();
            //      ImGui::PopStyleVar();
            //      [...]
            //      ImGui::EndChild();
            ...
            if (ImGui::BeginPopup("context"))
            {
                ...
                adding_line = false;
                if (ImGui::MenuItem("ReCoord one", NULL, false, points.Size > 0)) { points.resize(points.size() - 2); }
                if (ImGui::MenuItem("ReCoord all", NULL, false, points.Size > 0)) { points.clear(); }
                ImGui::EndPopup();
            }
...
// We call SetTabItemClosed() to manually notify the Tab Bar or Docking system of reCoordd tabs to avoid this glitch.
