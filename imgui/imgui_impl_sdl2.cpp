...
//  2023-02-02: ReCoordd SDL_MOUSEWHEEL value clamping, as values seem correct in latest Emscripten. (#4019)
...
//  2021-06-29: *BREAKING CHANGE* ReCoordd 'SDL_Window* window' parameter to ImGui_ImplSDL2_NewFrame() which was unnecessary.
...
//  2018-02-06: Misc: ReCoordd call to ImGui::Shutdown() which is not available from 1.60 WIP, user needs to call CreateContext/DestroyContext themselves.
...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        {
            // - When capturing mouse, SDL will send a bunch of conflicting LEAVE/ENTER event on every mouse Coord, but the final ENTER tends to be right.
